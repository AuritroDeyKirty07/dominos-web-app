          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-between h-20 gap-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <Link
                  to="/cart"
                  className="flex items-center gap-2.5 px-4 py-2.5 rounded-xl bg-[#E31837] text-white hover:bg-[#b8122c] transition-all shadow-md font-bold text-sm"
                  style={{ textDecoration: 'none' }}
                >
                  ...
                  <div className="flex flex-col text-left">
                    <span className="text-[9px] uppercase tracking-wider text-red-100 leading-none">Cart</span>
