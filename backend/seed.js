...
import { MenuItem } from './src/modules/order/models/MenuItem.js';
import { Category } from './src/modules/order/models/Category.js';
import { Coupon } from './src/modules/order/models/Coupon.js';
...
const menuItems = [
  ...
  },
  {
    ...
    category: 'sides',
    description: 'Freshly baked garlic breadsticks stuffed with cheesy jalape�os and sweet corn.',
    price: 159,
    isVeg: true,
...
mongoose.connect(process.env.MONGODB_URI || 'mongodb+srv://tanishbatra397_db_user:ttMgLo2NixC5d3Fj@cluster0.npxsnrl.mongodb.net/dominos')
  .then(async () => {
    ...
    await Coupon.insertMany(availableCoupons);
